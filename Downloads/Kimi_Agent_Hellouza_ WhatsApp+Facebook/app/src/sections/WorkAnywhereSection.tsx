...
interface WorkAnywhereSectionProps {
  className?: string;
}

export default function WorkAnywhereSection({ className = '' }: WorkAnywhereSectionProps) {
  ...
  return (
    <section ref={sectionRef} className={`section section-pinned ${className}`} style={{ zIndex: 80 }}>
      <div style={{
        width: '100%',
        height: '100%',
        display: 'flex',
        ...
        <div ref={pillsRef} style={{
          ...
          <div className="info-pill card card-pastel-peach" style={{ padding: '28px', height: '22vh' }}>
            ...
            <h3 className="heading-3" style={{ marginBottom: '8px' }}>Global opportunities</h3>
            <p className="body-small" style={{ color: 'var(--text-secondary)' }}>
              Roles open to multiple time zones.
            </p>
          </div>
          ...
          <div className="info-pill card card-pastel-lavender" style={{ padding: '28px', height: '22vh' }}>
            ...
            <h3 className="heading-3" style={{ marginBottom: '8px' }}>Visa & relocation support</h3>
            <p className="body-small" style={{ color: 'var(--text-secondary)' }}>
              See which companies offer sponsorship.
            </p>
          </div>
        </div>
        ...
        <div ref={photoRef} style={{ flex: 1.8 }}>
          <div className="card" style={{
            ...
            <div style={{
              ...
              <h2 className="heading-2" style={{ color: 'white' }}>Work anywhere.</h2>
            </div>
          </div>
        </div>
      </div>
